...
from database.orm_query import orm_get_banner, orm_get_categories, orm_get_products, Paginator, orm_delete_from_cart, \
    orm_reduce_product_in_cart, orm_add_to_cart, orm_get_user_carts
from kbds.inline import get_user_main_btns, get_user_catalog_btns, get_product_btns, get_user_cart
...
async def get_menu_content(session: AsyncSession, level: int, menu_name: str, category: int | None = None,
                           page: int | None = None, user_id: int | None = None, product_id: int | None = None):
    if level == 0:
